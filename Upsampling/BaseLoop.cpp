...
bool
BaseLoop::IsVertRegular(int vert) const
{
...
bool
BaseLoop::AreIrregularVertsIsolated() const
{
...
int
BaseLoop::_GetVertVertIndex(int vert) const
{
	return vert;
}

int
BaseLoop::_GetEdgeVertIndex(int edge) const
{
...
int
BaseLoop::_GetFaceVertIndex(int /*face*/) const
{
	assert(false);
	return -1;
}
...
int
BaseLoop::_GetEdgeEdgeIndex(int edge, int vertInEdge) const
{
	return 2 * edge + vertInEdge;
}

int
BaseLoop::_GetFaceEdgeIndex(int face, int edgeInFace) const
{
...
int
BaseLoop::_GetCentralFaceIndex(int face) const
{
...
int
BaseLoop::_GetCornerFaceIndex(int face, int vertInFace) const
{
...
void
BaseLoop::GetSubdividedEdges(std::vector< std::vector<int> >& edgeToVert) const
{
...
void
BaseLoop::GetSubdividedFaces(std::vector< std::vector<int> >& faceToVert)
{
...
Scalar
BaseLoop::_GetAlpha(int vert) const
{
...
Scalar
BaseLoop::_GetBeta(int vert) const
{
...
void
BaseLoop::BuildS0(SparseMatrixX& A) const
{
...
void
BaseLoop::_AssembleVertEvenInterior(int vi, TripletInserter out) const
{
	// Fig5 left [Wang et al. 2006]   
...
void
BaseLoop::_AssembleVertEvenBoundary(int vi, TripletInserter out) const
{
...
void
BaseLoop::_AssembleVertOddInterior(int edge, TripletInserter out) const
{
...
void
BaseLoop::_AssembleVertOddBoundary(int edge, TripletInserter out) const
{
...
void
BaseLoop::BuildS1(SparseMatrixX& A) const
{
...
void
BaseLoop::_AssembleEdgeEvenBoundary(int edge, int vertInEdge, TripletInserter out) const
{
...
void
BaseLoop::_InsertEdgeEdgeValue(int row, int col, int vert, int rSign, Scalar val, TripletInserter out) const
{
...
void
BaseLoop::_InsertEdgeFaceValue(int row, int face, int vert, int rSign, Scalar val, TripletInserter out) const
{
...
void
BaseLoop::_AssembleEdgeEvenPartialBoundary(int edge, int vertInEdge, TripletInserter out) const
{
	int row = _GetEdgeEdgeIndex(edge, vertInEdge);
	int vert = _mesh.GetEdgeVerts(edge)[vertInEdge];
	int rSign = (_GetVertVertIndex(vert) < _GetEdgeVertIndex(edge)) ? 1 : -1;
...
void
BaseLoop::_AssembleEdgeEvenInterior(int edge, int vertInEdge, TripletInserter out) const
{
	int vert = _mesh.GetEdgeVerts(edge)[vertInEdge];
	int edgeInVert = _mesh.GetEdgeIndexInVert(vert, edge);
...
void
BaseLoop::_AssembleEdgeOdd(int face, int edgeInFace, TripletInserter out) const
{
...
Mesh BaseLoop::meshSubdivide(int level)
{
